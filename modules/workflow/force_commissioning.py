...
class ForceCommissioningLog:
    COLUMNS = (
        ...
        "target_force_n",
        "error_n",
        "force_derivative_n_s",
        "derivative_interval_s",
        "z_offset_mm",
        "action",
        "status",
    )
        ...
        self.rows.append(
            {
                ...
                "force_derivative_n_s": float(force_derivative_n_s),
                "derivative_interval_s": float(derivative_interval_s),
